...
namespace remani_planner
{
    ...
    private:
        ...
        bool useFastArmer_;
        // ################################
        // C++: CR10 type + fixed joint origins begin
        // ################################
        ManipulatorType manipulator_type_;
        Eigen::Matrix4d T_cr10_fixed_[6];
        // ################################
        // C++: CR10 type + fixed joint origins end
        // ################################
        ...
        // ################################
        // C++: CR10 / Ranger mesh resources begin
        // ################################
        std::string mesh_resource_cr10_base_, mesh_resource_cr10_link1_, mesh_resource_cr10_link2_;
        std::string mesh_resource_cr10_link3_, mesh_resource_cr10_link4_, mesh_resource_cr10_link5_, mesh_resource_cr10_link6_;
        std::string mesh_resource_ranger_base_, mesh_resource_ranger_box_;
        // ################################
        // C++: CR10 / Ranger mesh resources end
        // ################################

        void setColorSet();
        void setLinkPoint();
        // ################################
        // C++: CR10 helpers begin
        // ################################
        ...
        // ################################
        // C++: URDF RPY = Rz(y)*Ry(p)*Rx(r) begin
        // ################################
        Eigen::Matrix3d urdfRpyToRotation(double r, double p, double y){
