#!/usr/bin/env python3
# ################################
# Python: final completion rostest begin
# ################################
...
def publishers(topic):
    published, _, _ = rosgraph.Master("/final_completion").getSystemState()
...
class FinalCompletionTest(unittest.TestCase):
    ...
    def test_dry_run_reaches_succeeded_without_writes(self):
        ...
        self.assertAlmostEqual(1.0, done.execution_progress, places=2)
...
if __name__ == "__main__":
    rospy.init_node("test_final_completion")
    rostest.rosrun("remani_real", "test_final_completion", FinalCompletionTest)
# ################################
# Python: final completion rostest end
# ################################
